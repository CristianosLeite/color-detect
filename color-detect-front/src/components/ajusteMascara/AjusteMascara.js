...
import { PrincipalAjusteMascara, Header, InputAjuste, Content, ContentLinha01, ContentLinha02, ContentLinha03, ContentLinha04, Titulo, ButtonBlue, ContentLinha05 } from "./styles"
...
export default class AjusteMascara extends Component {
    ...
    getMask = () => {
        axios.get(`${this.state.urlCamera}/mask`, {timeout: 3000})
            .then(response => {
    ...
    saveMask = () => {
        ...
        axios.post(`${this.state.urlCamera}/mask`, mask, {timeout: 3000})
            .then(response => {
                Swal.fire({
                    icon: 'success',
                    title: 'Salvo.',
        ...
        return (
            <PrincipalAjusteMascara>
                ...
                <Content>
                    <ContentLinha01>
                        1x:
                        <InputAjuste name='x1' type='number' value={this.state.x1} onChange={this.updateIputs} />
                        1y:
                        <InputAjuste name='y1' type='number' value={this.state.y1} onChange={this.updateIputs} />
                    </ContentLinha01>
                    <ContentLinha02>
                        2x:
                        <InputAjuste name='x2' type='number' value={this.state.x2} onChange={this.updateIputs} />
                        2y:
                        <InputAjuste name='y2' type='number' value={this.state.y2} onChange={this.updateIputs} />
                    </ContentLinha02>
                    <ContentLinha03>
                        3x:
                        <InputAjuste name='x3' type='number' value={this.state.x3} onChange={this.updateIputs} />
                        3y:
                        <InputAjuste name='y3' type='number' value={this.state.y3} onChange={this.updateIputs} />
                    </ContentLinha03>
                    <ContentLinha04>
                        4x:
                        <InputAjuste name='x4' type='number' value={this.state.x4} onChange={this.updateIputs} />
                        4y:
                        <InputAjuste name='y4' type='number' value={this.state.y4} onChange={this.updateIputs} />
                    </ContentLinha04>
                    <ContentLinha05>
