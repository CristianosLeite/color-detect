...
class Interface(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.LabelStatusCam01.setStyleSheet("background-color: red; border: 1px solidblack;")

        self.LabelStatusPLC01.setText('PLC desconectado')
        self.LabelStatusPLC01.setStyleSheet("background-color: red; border: 1px solidblack;")
